			...
			<div id="content">
				...
				<div id="inner-content" class="wrap ">
						...
						<main id="main" class="m-all t-2of3 d-5of7 " role="main" itemscope itemprop="mainContentOfPage" itemtype="http://schema.org/Blog">
							...
							<h1 class="archive-title h2"><span><?php _e( 'Posts Categorized:', 'dghtheme' ); ?></span> <?php single_cat_title(); ?></h1>
							...
							<?php else : ?>
									...
									<article id="post-not-found" class="hentry ">
										...
										<footer class="article-footer">
												<p><?php _e( 'This is the error message in the taxonomy-custom_cat.php template.', 'dghtheme' ); ?></p>
										</footer>
									</article>
